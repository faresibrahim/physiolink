...
void main() {
  ...
  group('DioExerciseRepository', () {
    test('getExercises maps JSON response to ExerciseAssignment list', () async {
            ...
            'items': [
              {
                ...
                'difficulty': 1, // DifficultyLevel.moderate (index-based enum)
                'sets': 3,
                'reps': 12,
                'durationMinutes': 5,
                'feedback': null,
    ...
    test('getExercises returns ServerFailure on DioException with status 500', () async {
