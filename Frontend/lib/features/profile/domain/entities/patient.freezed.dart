...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,patientId,firstName,lastName,phoneNumber,email,diagnosis,therapistName,clinicName,createdAt,isActive,const DeepCollectionEquality().hash(exercises),const DeepCollectionEquality().hash(appointments));

@override
String toString() {
  return 'Patient(patientId: $patientId, firstName: $firstName, lastName: $lastName, phoneNumber: $phoneNumber, email: $email, diagnosis: $diagnosis, therapistName: $therapistName, clinicName: $clinicName, createdAt: $createdAt, isActive: $isActive, exercises: $exercises, appointments: $appointments)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,patientId,firstName,lastName,phoneNumber,email,diagnosis,therapistName,clinicName,createdAt,isActive,const DeepCollectionEquality().hash(_exercises),const DeepCollectionEquality().hash(_appointments));
